...
class MLPPolicy(BasePolicy, nn.Module, metaclass=abc.ABCMeta):
    ...
    def get_action(self, obs: np.ndarray) -> np.ndarray:
        ...
        action_ditribution = self(ptu.from_numpy(observation))
        action = ptu.to_numpy(action_ditribution.sample())
        return action
...
class MLPPolicyPG(MLPPolicy):
    ...
    def update(self, observations, actions, advantages, q_values=None):
        ...
        log_pi = self(observations).log_prob(actions)
        ...
        if self.nn_baseline:
            ...
            # print(targets.shape, baseline_prediction.shape)
            assert baseline_prediction.shape == targets.shape
